...
var element = document.getElementById("thetextheader");
...
function display(selected) {
  if (selected == 'math1') {
    ...
    texttoshow = `<h1>一對一小學英文基礎課程</h1><br>
      ...
      <ul>
      <li>獨家詳盡筆記、練習、詞匯表。</li>
      <li>根據小學的教學大綱而設計，特別班一對一師資比例，針對同學弱點調整教材，讓小學同學重拾對英文的興趣和信心。</li>
      </ul>
      <hr>
      <b>費用:<br>
      小三至小六 $1600/8堂<br>
    ...
    texttoshow = `<h1>小學英文進階課程</h1><br>
      ...
      <ul>
      <li>獨家詳盡筆記、練習、詞匯表。</li>
      <li>根據小學的教學大綱而設計，與學校進度相輔相成。老師會講解題目，教授常用生字，並糾正同學的讀音。另外，每個月的最後一課都有溫習單元，幫助同學溫故知新</li>
      </ul>
      <hr>
      <b>費用:<br>
      小三至小六 $850/4堂<br>
